    ...
    function () {
      async function fetchMovies() {
        try {
          ...
          if (!res.ok) {
            throw new Error("Somethin went wrong with fetching...");
          }
        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedMovieList
                watched={watched}
                onDeleteWathed={handleDeleteWatch}
              />
            </>
          )}
        </Box>
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  const isWatched = watched.map((movie) => movie.imdbID).incudes(selectedId);
          ...
          <section>
            <div className="rating">
              ...
              {!isWatched ? (
                ...
                <p>Your rated this movie {}watchedUserRating</p>
              )}
            </div>
            <p>
              <em>{plot}</em>
